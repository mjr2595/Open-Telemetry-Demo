...
exports.searchPathForTest = exports.PluginLoader = exports.HookState = void 0;
...
class PluginLoader {
    ...
    load(plugins) {
        if (this._hookState === HookState.UNINITIALIZED) {
            ...
            const modulesToIgnore = core_1.getEnv().OTEL_NO_PATCH_MODULES;
            ...
            hook(modulesToHook, (exports, name, baseDir) => {
                ...
                if (modulesToIgnore[0] === DISABLE_ALL_PLUGINS) {
                    this.logger.info(`PluginLoader#load: skipped patching module ${name} because all plugins are disabled (${modulesToIgnore.join(',')})`);
                    return exports;
                }
                if (modulesToIgnore.includes(name)) {
                    this.logger.info(`PluginLoader#load: skipped patching module ${name} because it was on the ignore list (${modulesToIgnore.join(',')})`);
                    return exports;
                }
