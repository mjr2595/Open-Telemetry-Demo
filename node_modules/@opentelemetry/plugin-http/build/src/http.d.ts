...
export declare class HttpPlugin extends BasePlugin<Http> {
    ...
    protected _getPatchOutgoingGetFunction(clientRequest: (options: RequestOptions | string | url.URL, ...args: HttpRequestArgs) => ClientRequest): (_original: Func<ClientRequest>) => Func<ClientRequest>;
    /**
