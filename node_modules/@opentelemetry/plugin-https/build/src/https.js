...
class HttpsPlugin extends plugin_http_1.HttpPlugin {
    ...
    patch() {
        ...
        if (this._moduleExports &&
            ...
            api_1.diag.error('Could not apply patch to %s.emit. Interface is not as expected.', this.moduleName);
        }
        ...
        if (semver.satisfies(this.version, '>=8.0.0')) {
            shimmer.wrap(this._moduleExports, 'get', this._getPatchHttpsOutgoingGetFunction(this._moduleExports.request));
        }
